...
REGISTER_MQSERIES_LONG_CONSTANT(MQSTAT_TYPE_RECONNECTION_ERROR);
 ...
 /* Callback Options */
#ifdef MQCBDO_NONE
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_NONE);
#endif /* MQCBDO_NONE*/
#ifdef MQCBDO_START_CALL
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_START_CALL);
#endif /* MQCBDO_START_CALL*/
#ifdef MQCBDO_STOP_CALL
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_STOP_CALL);
#endif /* MQCBDO_STOP_CALL*/
#ifdef MQCBDO_REGISTER_CALL
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_REGISTER_CALL);
#endif /* MQCBDO_REGISTER_CALL*/
#ifdef MQCBDO_DEREGISTER_CALL
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_DEREGISTER_CALL);
#endif /* MQCBDO_DEREGISTER_CALL*/
#ifdef MQCBDO_FAIL_IF_QUIESCING
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_FAIL_IF_QUIESCING);
#endif /* MQCBDO_FAIL_IF_QUIESCING*/
#ifdef MQCBDO_EVENT_CALL
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_EVENT_CALL);
#endif /* MQCBDO_EVENT_CALL*/
#ifdef MQCBDO_MC_EVENT_CALL
REGISTER_MQSERIES_LONG_CONSTANT(MQCBDO_MC_EVENT_CALL);
#endif /* MQCBDO_MC_EVENT_CALL*/

 /* This is the type of the Callback Function */
#ifdef MQCBT_MESSAGE_CONSUMER
REGISTER_MQSERIES_LONG_CONSTANT(MQCBT_MESSAGE_CONSUMER);
#endif /* MQCBT_MESSAGE_CONSUMER*/
#ifdef MQCBT_EVENT_HANDLER
REGISTER_MQSERIES_LONG_CONSTANT(MQCBT_EVENT_HANDLER);
#endif /* MQCBT_EVENT_HANDLER*/

 /* Buffer size values */
#ifdef MQCBD_FULL_MSG_LENGTH
REGISTER_MQSERIES_LONG_CONSTANT(MQCBD_FULL_MSG_LENGTH);
#endif /* MQCBD_FULL_MSG_LENGTH*/

 /* Operation codes for MQCTL */
#ifdef MQOP_START
REGISTER_MQSERIES_LONG_CONSTANT(MQOP_START);
#endif /* MQOP_START*/
#ifdef MQOP_START_WAIT
REGISTER_MQSERIES_LONG_CONSTANT(MQOP_START_WAIT);
#endif /* MQOP_START_WAIT*/
#ifdef MQOP_STOP
REGISTER_MQSERIES_LONG_CONSTANT(MQOP_STOP);
#endif /* MQOP_STOP*/

 /* Operation codes for MQCB */
#ifdef MQOP_REGISTER
REGISTER_MQSERIES_LONG_CONSTANT(MQOP_REGISTER);
#endif /* MQOP_REGISTER*/
#ifdef MQOP_DEREGISTER
REGISTER_MQSERIES_LONG_CONSTANT(MQOP_DEREGISTER);
#endif /* MQOP_DEREGISTER*/

 /* Operation codes for MQCTL and MQCB */
#ifdef MQOP_SUSPEND
REGISTER_MQSERIES_LONG_CONSTANT(MQOP_SUSPEND);
#endif /* MQOP_SUSPEND*/
#ifdef MQOP_RESUME
REGISTER_MQSERIES_LONG_CONSTANT(MQOP_RESUME);
#endif /* MQOP_RESUME*/

 /* Object Handle */
#ifdef MQHO_UNUSABLE_HOBJ
REGISTER_MQSERIES_LONG_CONSTANT(MQHO_UNUSABLE_HOBJ);
#endif /* MQHO_UNUSABLE_HOBJ*/
#ifdef MQHO_NONE
REGISTER_MQSERIES_LONG_CONSTANT(MQHO_NONE);
#endif /* MQHO_NONE*/
